...
def makePotentialModel():
    ...
    # EDIT: all BARYONIC spheroidal components put into a single axisymmetric Multipole potential
    pot_mul_baryon = agama.Potential(type='Multipole',
        density=[params_BH, params_NSC] + params_NSD,
        lmax=12, gridSizeR=36, rmin=1e-4, rmax=1000)
    ...
    # EDIT: also export baryonic only potentials
    agama.Potential(pot_mul_baryon, pot_cyl_full).export('MWPotentialHunter24_baryon_full')
    agama.Potential(pot_mul_baryon, pot_cyl_axi ).export('MWPotentialHunter24_baryon_axi')
